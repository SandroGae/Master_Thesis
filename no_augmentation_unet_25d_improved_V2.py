...
BASE_NAME = "no_augmentation_unet_25d_SSIM_middle_improved_V2"
...
print(f"\nK-Fold (No Augmentation) abgeschlossen. Durchschnittlicher MAE: {np.mean(all_fold_scores):.6f}")