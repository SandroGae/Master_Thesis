...
def psnr_metric_3d_per_sample(y_true, y_pred):
    ...
    return psnr  # Keras zeigt den Mittelwert über N an


# ==== NEU (SSIM für 3D via Slices) ============================================
def _to_4d(yt, yp):
    # (B,D,H,W,C) -> (B*D, H, W, C)
...
def combined_mae_ssim_3d(y_true, y_pred, alpha=0.7):
    ...
    ssim = ssim_3d_mean(yt, yp, max_val=1.0)
...
model.compile(
    optimizer=optimizer,
    # ==== GEÄNDERT: kombinierter Loss (70% SSIM, 30% MAE) ====================
    loss=lambda yt, yp: combined_mae_ssim_3d(yt, yp, alpha=0.7),
    # ==========================================================================
...
meta = make_meta_dict(
    ...
    # ==== GEÄNDERT: Meta sauber deklarieren ==================================
