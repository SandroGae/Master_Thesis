...
SERIES_CONFIG = {
    ...
    13: {"slice_idx": 7,  "roi_x": (120, 141), "roi_y": (0, 192), "bg_gap": 77,   "vis_p": (0.5, 88.0), "ylim_raw": (3.5, 6.0), "ylim_sbr": (-0.2, 0.5), "fit_window": (85, 125)},
    ...
    # Block 2
    29: {"slice_idx": 24, "roi_x": (57, 78),   "roi_y": (0, 192), "bg_gap": 44,  "vis_p": (0.5, 95.0), "ylim_raw": (3.5, 6.5), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    30: {"slice_idx": 14, "roi_x": (219, 240),   "roi_y": (0, 192), "bg_gap": -171,   "vis_p": (0.5, 97.0), "ylim_raw": (3.5, 6.5), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    32: {"slice_idx": 31, "roi_x": (53, 74),   "roi_y": (0, 192), "bg_gap": -73,  "vis_p": (0.5, 92.0), "ylim_raw": (3.5, 6.5), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    35: {"slice_idx": 23, "roi_x": (106, 127), "roi_y": (0, 192), "bg_gap": 38,   "vis_p": (0.5, 90.0), "ylim_raw": (3.5, 6.0), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    36: {"slice_idx": 15, "roi_x": (55, 76),   "roi_y": (0, 192), "bg_gap": 22,  "vis_p": (0.5, 95.0), "ylim_raw": (3.5, 7.0), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    38: {"slice_idx": 35, "roi_x": (109, 130), "roi_y": (0, 192), "bg_gap": 80,   "vis_p": (0.5, 90.0), "ylim_raw": (3.5, 6.0), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    41: {"slice_idx": 18, "roi_x": (33, 54),   "roi_y": (0, 192), "bg_gap": 37,   "vis_p": (0.5, 94.5), "ylim_raw": (3.5, 6.5), "ylim_sbr": (-0.2, 0.5), "fit_window": (84, 124)},
    42: {"slice_idx": 35, "roi_x": (157, 178), "roi_y": (0, 192), "bg_gap": 42,   "vis_p": (0.5, 90.0), "ylim_raw": (3.5, 6.5), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    45: {"slice_idx": 20, "roi_x": (74, 95),   "roi_y": (0, 192), "bg_gap": 55,   "vis_p": (0.5, 97.0), "ylim_raw": (3.5, 6.5), "ylim_sbr": (-0.2, 0.6), "fit_window": (90, 130)},
    46: {"slice_idx": 37, "roi_x": (213, 234), "roi_y": (0, 192), "bg_gap": -83,  "vis_p": (0.5, 90.0), "ylim_raw": (3.5, 6.5), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    ...
    55: {"slice_idx": 21, "roi_x": (177, 198), "roi_y": (0, 192), "bg_gap": -76,  "vis_p": (0.5, 95.0), "ylim_raw": (3.5, 5.5), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    ...
    59: {"slice_idx": 15, "roi_x": (190, 211), "roi_y": (0, 192), "bg_gap": -211, "vis_p": (0.5, 96.0), "ylim_raw": (3.5, 7.0), "ylim_sbr": (-0.2, 0.5), "fit_window": (93, 133)},
    64: {"slice_idx": 5,  "roi_x": (213, 234), "roi_y": (0, 192), "bg_gap": -231, "vis_p": (0.5, 95.0), "ylim_raw": (3.5, 6.5), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
    67: {"slice_idx": 10, "roi_x": (30, 51),   "roi_y": (0, 192), "bg_gap": 48,   "vis_p": (0.5, 95.0), "ylim_raw": (3.5, 5.5), "ylim_sbr": (-0.2, 0.5), "fit_window": (90, 130)},
