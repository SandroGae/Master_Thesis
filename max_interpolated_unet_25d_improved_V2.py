...
BASE_NAME = "cross_val_unet_25d_improved_V2_interpolated"
...
for fold, (train_idx, val_idx) in enumerate(kf.split(series_indices)):
    ...
    print(f"Generiere Volumina für Fold {fold_id} (Dichte Verdoppelt)...")
    ...
    # Stride 6: 73
    # Stride 12: 65
    # Stride 24: 73 --> in total 18'400 Volumina
        if s == 12:
            step = 3
        elif s == 24:
            step = 2
