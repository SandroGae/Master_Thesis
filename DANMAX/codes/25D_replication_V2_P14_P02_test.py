...
# P14 und P02 Konfiguration
CONFIGS = [
    {"point": "P14", "alpha": 2.0/6.0, "beta": 0.0},
    {"point": "P02", "alpha": 0.0, "beta": 2.0/6.0} # Alpha und Beta vertauscht
]
...
# =====================================================
# HILFSFUNKTIONEN DATEN (ALTE LOGIK)
# =====================================================
...
# =====================================================
# METRIKEN & NEUER TRIPLE LOSS (AUS NEUEM CODE)
# =====================================================
...
# =====================================================
# DATEN LADEN & 60/20/20 SPLIT LOGIK (NUR EINMALIG)
# =====================================================
def main():
    ...
    # Datasets bauen (Nur einmal nötig, können für beide Modelle genutzt werden)
    ...
    for config in CONFIGS:
        ...
        RUN_NAME = f"unet_25d_OLDLOGIC_{point_name}__seed{SEED}__alpha{alpha:.2f}_beta{beta:.2f}__{RUN_ID}"
        print(f"\n{'='*60}")
        ...
        # Triple Loss aus dem neuen Code anwenden
        model.compile(
            optimizer=optimizer, 
