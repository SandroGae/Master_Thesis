...
# =====================================================
# 2. METRIKEN & LOSS (Reines Float32)
# =====================================================
...
# 5. MAIN LOOP
# =====================================================
print(f"--- STARTE HDF5-TRAINING PUNKT {MY_POINT_IDX} (a={MY_ALPHA}, b={MY_BETA}) ---")

# Einmaliges Laden der Daten pro Job (alle Seeds nutzen diese Kopie im RAM)
...
for current_seed in SEEDS:
    ...
    # Dataset aus RAM (from_tensor_slices)
    ...
    callbacks = [
        tf.keras.callbacks.ModelCheckpoint(filepath=str(point_dir / f"{RUN_NAME}.h5"), monitor='val_loss', save_best_only=True),
